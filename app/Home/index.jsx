                ...
                <div className="wrapper">
                    <div className="container about">
                        ...
                        <ul className="socialLinks">
                            <li><a href="https://www.linkedin.com/in/trekforever"><i className="fa fa-linkedin" /></a></li>
                            <li><a href="https://twitter.com/trekforever"><i className="fa fa-twitter" /></a></li>
                            <li><a href="https://plus.google.com/u/0/111807495882361387546/"><i className="fa fa-google-plus" /></a></li>
                            <li><a href="https://github.com/trekforever"><i className="fa fa-github" /></a></li>
                            <li><a href="http://stackoverflow.com/users/1547196/trekforever"><i className="fa fa-stack-overflow" /></a></li>
                        </ul>
                        <br />
